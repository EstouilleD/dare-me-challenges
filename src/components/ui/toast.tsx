...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-full p-1.5 text-foreground/70 bg-muted/50 hover:bg-muted transition-colors group-[.destructive]:text-red-200 group-[.destructive]:bg-red-900/30 group-[.destructive]:hover:bg-red-900/50 hover:text-foreground focus:outline-none focus:ring-2",
      className,
    )}
    toast-close=""
    {...props}
