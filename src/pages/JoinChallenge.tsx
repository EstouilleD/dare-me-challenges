...
const JoinChallenge = () => {
  ...
  if (loading) {
    return (
      <div className="safe-top min-h-screen flex items-center justify-center bg-background">
  ...
  if (joined) {
    return (
      <div className="safe-top min-h-screen flex items-center justify-center bg-background p-4">
